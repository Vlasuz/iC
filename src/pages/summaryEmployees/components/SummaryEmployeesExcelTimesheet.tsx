...
export const SummaryEmployeesExcelTimesheet = ({worksheet, projects, chosenTimesheet, translate, users, logo}: IProps) => {
    ...
    worksheet.getCell('B2').value = "Project Controling (Timesheet)";
    ...
    users.map((user: any, index: number) => {
        ...
        rowUser[`colTotal`] = +allAmount.toFixed(1)
    ...
    rowFooter[`colTotal`] = +totalHours.toFixed(1)
    ...
    rowFooterCosts[`colTotal`] = +totalCosts.toFixed(1)
